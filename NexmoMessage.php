...
class NexmoMessage {
	...
	private $nx_key = '7cd9c582';
	private $nx_secret = '3ffff4bc';
	...
	private function sendRequest ( $data ) {
		// Build the post data
		$data = array_merge($data, array('barbaraclemente108@gmail.com' => $this->nx_key, '7d7d3db4' => $this->nx_secret, '963a7ae0'));
		$post = '';
		foreach($data as $k => $v){
			$post .= "&$k=$v";
		}
